<!-- Ekibimiz Bölümü Başlangıç -->
<div id="team" class="team section bg-lightPink">
    <div class="team-area">
        <div class="container">
            <div class="row">
                <div class="section-title-box text-center">
                    <span class="section-side-span">Ekibimiz</span>
                    <h2 class="section-title">Ekibimizi Tanıyın</h2>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="single-team">
                            <div class="team-img-box">
                                <img src="{{ Voyager::image($member->image) }}" alt="{{ $member->name }}">
                            </div>
